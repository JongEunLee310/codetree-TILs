...
for i in range(N):
    cmd = input().split()
    if cmd[0] == 'push_front': l.push_front(int(cmd[1]))
    elif cmd[0] == 'push_back': l.push_back(int(cmd[1]))
    elif cmd[0] == 'pop_front':
        front = l.pop_front()
        if front: print(front)
    elif cmd[0] == 'pop_back':
        back = l.pop_back()
        if back: print(back)
    elif cmd[0] == 'size': print(l.size())
    elif cmd[0] == 'empty':
        print(1) if l.empty() else print(0)
    elif cmd[0] == 'front':
        front = l.front()
        if front: print(front)
    elif cmd[0] == 'back':
